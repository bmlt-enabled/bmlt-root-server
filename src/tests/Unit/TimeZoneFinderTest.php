...
{
    private function finder(): TimeZoneFinder
    {
        return app(TimeZoneFinder::class);
    }
    ...
    public function testFindReturnsAZoneForInRangeOceanCoordinates(): void
    {
        // The underlying mapper covers oceans with nautical zones, so in-range
        // coordinates always resolve to some IANA zone (unlike a boundary-only lookup).
        $result = $this->finder()->find(30.0, -40.0);
