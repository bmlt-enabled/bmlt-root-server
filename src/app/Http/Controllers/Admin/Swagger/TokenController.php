...
{
    /**
     * @OA\Post(path="/api/v1/auth/token", summary="Create Token", description="Exchange credentials for a new token", operationId="authToken", tags={"auth"},
    ...
    /**
     * @OA\Post(path="/api/v1/auth/refresh", summary="Refresh Token", description="Refresh token.", operationId="authRefresh", tags={"auth"}, security={{"bearerAuth":{}}},
    ...
    /**
     * @OA\Post(path="/api/v1/auth/logout", summary="Logout", description="Revoke token and logout.", operationId="authLogout", tags={"auth"}, security={{"bearerAuth":{}}},
