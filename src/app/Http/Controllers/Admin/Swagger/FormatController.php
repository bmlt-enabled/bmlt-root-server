...
class FormatController extends Controller
{
    ...
    /**
     * @OA\Get(path="/api/v1/formats", summary="Retrieve formats", description="Retrieve formats", operationId="getFormats", tags={"formats"}, security={{"bearerAuth":{}}},
    ...
    /**
     * @OA\Get(path="/api/v1/formats/{formatId}", summary="Retrieve a format", description="Retrieve a format", operationId="getFormat", tags={"formats"}, security={{"bearerAuth":{}}},
    ...
    /**
     * @OA\Post(path="/api/v1/formats", summary="Create Format", description="Creates a format.", operationId="createFormat", tags={"formats"}, security={{"bearerAuth":{}}},
    ...
    /**
     * @OA\Put( path="/api/v1/formats/{formatId}", summary="Update format", description="Updates a format.", operationId="updateFormat", tags={"formats"}, security={{"bearerAuth":{}}},
     *     @OA\Parameter(description="ID of format", in="path", name="formatId", required=true, example="1",
     *         @OA\Schema(type="integer", format="int64")
     *     ),
     *     @OA\RequestBody(required=true, description="Pass in format object",
    ...
    /**
     * @OA\Patch(path="/api/v1/formats/{formatId}", summary="Patches a single format", description="Patches a single format by id.", operationId="patchFormat", tags={"formats"}, security={{"bearerAuth":{}}},
     *     @OA\Parameter(description="ID of format", in="path", name="formatId", required=true, example="1",
     *         @OA\Schema(type="integer", format="int64")
     *     ),
