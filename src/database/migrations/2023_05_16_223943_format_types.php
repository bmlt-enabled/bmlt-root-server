    ...
    public function up()
    {
        ...
        if (!legacy_config('aggregator_mode_enabled')) {
            ...
            DB::table('comdef_format_types')->insert([
                ['key_string' => 'FC1', 'api_key' => 'MEETING_FORMAT', 'position_int' => '1'],
                ['key_string' => 'FC2', 'api_key' =>  'LOCATION', 'position_int' => '2'],
                ['key_string' => 'FC3', 'api_key' => 'COMMON_NEEDS_OR_RESTRICTION', 'position_int' => '3'],
                ['key_string' => 'O', 'api_key' => 'OPEN_OR_CLOSED', 'position_int' => '4'],
                ['key_string' => 'LANG', 'api_key' => 'LANGUAGE', 'position_int' => '5'],
            ]);
        }
    }
