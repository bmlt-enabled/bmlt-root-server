<?php
/****************************************************************************************//**
* \file GetCoverageArea.php                                                                     *
* \brief Returns an XML response, containing the schema for the GetCoverageArea XML call            *
        ...
        <xs:complexType>
            <xs:sequence>
                <xs:element name="row">
                    <xs:complexType>
                        <xs:sequence>
                            <xs:element name="nw_corner_longitude" type="xs:float"/>
                            <xs:element name="nw_corner_latitude" type="xs:float"/>
                            <xs:element name="se_corner_longitude" type="xs:float"/>
                            <xs:element name="se_corner_latitude" type="xs:float"/>
                        </xs:sequence>
