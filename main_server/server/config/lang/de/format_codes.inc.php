...
/** \file	format_codes.inc.php
	...
	$comdef_format_types = array (
									...
									"FC1"=>"Meetingsformat",			/**< Meeting Format (Speaker, Book Study, etc.)  */
									"FC2"=>"Örtliche Besonderheiten",			/**< Location Code (Wheelchair Accessible, Limited Parking, etc.)  */
									"FC3"=>"Teilnahme Beschränkung"	/**< Attendance Restriction (Men Only, Closed, Open, No Children, etc.)  */
									);
?>