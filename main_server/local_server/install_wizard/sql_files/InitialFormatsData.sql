...
(48, 'PER', NULL, NULL, 'en', 'Persian', 'Persian speaking meeting', 'FC1'),
...
(50, 'WEB', NULL, NULL, 'en', 'Online', 'Online (Web/Chat) Meeting.', 'FC2'),
(1, 'B', NULL, NULL, 'en', 'Beginners', 'This meeting is focused on the needs of new members of NA.', 'FC3'),
(2, 'BL', NULL, NULL, 'en', 'Bi-Lingual', 'This Meeting can be attended by speakers of English and another language.', 'FC3'),
(3, 'BT', NULL, NULL, 'en', 'Basic Text', 'This meeting is focused on discussion of the Basic Text of Narcotics Anonymous.', 'FC1'),
(4, 'C', NULL, NULL, 'en', 'Closed', 'This meeting is closed to non-addicts. You should attend only if you believe that you may have a problem with substance abuse.', 'FC3'),
...
(23, 'SG', NULL, NULL, 'es', 'Guia Para Trabajar los Pasos', 'Esta reunión se centra en la discusión del texto Guia Para Trabajar los Pasos.', 'FC1'),
(24, 'SL', NULL, NULL, 'es', 'ASL', 'Esta reunión proporciona intérprete (ASL) para los sordos.', 'FC2'),
(51, 'OUV', NULL, NULL, 'en', 'ouvert', 'Cette réunion est ouvert au public', NULL),
(26, 'So', NULL, NULL, 'es', 'Solamente Orador', 'Esta reunión es de orador solamente. Otros asistentes no participan en la discusión.', 'FC1'),
(27, 'St', NULL, NULL, 'es', 'Paso', 'Esta reunión se centra en la discusión de los doce pasos de NA.', 'FC1'),
(28, 'Ti', NULL, NULL, 'es', 'Contador de Tiempo', 'Esta reunión tiene el tiempo de compartir limitado por un contador de tiempo.', 'FC1'),
(29, 'To', NULL, NULL, 'es', 'Tema', 'Esta reunión se basa en un tema elegido por el orador o por la conciencia del grupo.', 'FC1'),
...
(1, 'B', NULL, NULL, 'fr', 'Débutants', 'Cette réunion est axée sur les besoins des nouveaux membres de NA.', 'FC3'),
...
(10, 'GL', NULL, NULL, 'fr', 'Gais, lesbiennes, transsexuel(le)s, bisexuel(le)s', 'Cette réunion est axée sur les besoins des membres gais, lesbiennes, transsexuel(le)s et bisexuel(le)s de NA.', 'FC3'),
...
(31, 'TW', NULL, NULL, 'fr', 'Atelier sur les traditions', 'Cette réunion est une discussion détaillée d\'une ou de plusieurs des Douze Traditions de NA', 'FC1'),
...
(52, 'DC', NULL, NULL, 'en', 'Childcare', 'Childcare is available', 'FC3'),
(53, 'K', NULL, NULL, 'en', 'Keytag', 'This is a meeting where keytags celebrating lengths of clean time are handed out', 'FC1'),
(54, 'HIV', NULL, NULL, 'en', 'HIV', 'This meeting is focused on the needs of HIV positive members.', 'FC3'),
(55, 'IG', NULL, NULL, 'en', 'Introductory Guide', 'This meeting reads from the Introductory Guide to NA', 'FC1');
