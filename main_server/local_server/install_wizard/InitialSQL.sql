IF (NOT EXISTS (SELECT * FROM '%%PREFIX%%_comdef_users'))
    BEGIN
        CREATE TABLE IF NOT EXISTS `%%PREFIX%%_comdef_users` (
        ...
        INSERT INTO `%%PREFIX%%_comdef_users` (`id_bigint`, `user_level_tinyint`, `name_string`, `description_string`, `email_address_string`, `login_string`, `password_string`, `last_access_datetime`, `lang_enum`) VALUES
        (1, 1, 'Server Administrator', 'Main Server Admin', '', '%%admin_login%%', '%%admin_password%%', '', 'en');

        CREATE TABLE IF NOT EXISTS `%%PREFIX%%_comdef_formats` (
        ...
        CREATE TABLE IF NOT EXISTS `%%PREFIX%%_comdef_meetings_data` (
        ...
        CREATE TABLE IF NOT EXISTS `%%PREFIX%%_comdef_meetings_main` (
          `id_bigint` bigint(20) unsigned NOT NULL auto_increment,
          `worldid_mixed` varchar(255) default NULL,
        ...
        CREATE TABLE IF NOT EXISTS `%%PREFIX%%_comdef_meetings_longdata` (
          `meetingid_bigint` bigint(20) unsigned NOT NULL,
          `key` varchar(32) NOT NULL,
        ...
        CREATE TABLE IF NOT EXISTS `%%PREFIX%%_comdef_service_bodies` (
          `id_bigint` bigint(20) unsigned NOT NULL auto_increment,
          `name_string` tinytext NOT NULL,
          `description_string` text NOT NULL,
          `lang_enum` varchar(7) NOT NULL default 'en',
        ...
        CREATE TABLE IF NOT EXISTS `%%PREFIX%%_comdef_changes` (
          `id_bigint` bigint(20) unsigned NOT NULL auto_increment,
