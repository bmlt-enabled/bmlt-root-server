...
$comdef_server_admin_strings = array('server_admin_disclosure' => 'Administração do Servidor',
    ...
    // 'server_admin_ui_problem_meetings' => 'reuniões foram encontradas na planilha que não existiam na base de dados. Isso pode acontecer quando uma reunião é apagada ou não publicada. Os IDs de reunião são: ',
    ...
    'world_format_codes' => array(
        ...
        'OPEN' => 'Aberta',
        'CLOSED' => 'Fechada',
        'WCHR' => 'Acessivel à Cadeirante',
        'BEG' => 'Recém-Chegados',
        'BT' => 'Texto Básico',
        'CAN' => 'Luz de Velas',
        'CPT' => '12 Conceitos',
        'CW' => 'Crianças bem vindas',
        'DISC' => 'Partilha',
        'GL' => 'LGBTQ+',
        'IP' => 'Estudo de IPs',
        'IW' => 'Estudo Isto Resulta',
        'JFT' => 'Estudo do Só Por Hoje',
        'LC' => 'Estudo Vivendo Limpo',
        ...
        'SMOK' => 'Permitido Fumar',
        'SPK' => 'Temática',
        'STEP' => 'Passos',
        'SWG' => 'Estudo Guia de Passos',
        'TOP' => 'Tema',
        'TRAD' => 'Tradições',
        'VAR' => 'Formato Variável',
        'W' => 'Só Mulheres',
        'Y' => 'Só Jovens',
        'LANG' => 'Lingua Estrangeira',
        'GP' => 'Guia de Principios',
        'NC' => 'Não permite crianças',
        'CH' => 'Fechado em feriados',
