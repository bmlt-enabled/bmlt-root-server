...
class c_comdef_data_importer
{
    ...
    */
    function AddOneMeeting (&$in_out_meeting_array,  ///< The meeting data, as an associative array. It must have the exact keys for the database table columns. No prompts, data type, etc. That will be supplied by the routine. Only a value. The 'id_bigint' field will be set to the new meeting ID.
    ...
    */
    function GeocodeAddress (	$in_address,	///< The address, in a single string, to be sent to the geocoder.
                                ...
                                )
    {
        ...
        do
            ...
            elseif ( !$retry )
                ...
                while ( microtime_float() <= $t ) {};	// Real, REAL basic delay, because Google doesn't like 'bots.
                }
            else
                {
                $ret = null;
